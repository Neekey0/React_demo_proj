...
function EmpForm() {
    ...
    console.log(empData, "empDATAAAA")

    // const schema = Yup.object().shape({
    //     empName: Yup.string().empName.required(),
    //     // salary: Yup.int().required(),
    ...
    const handleInputChangeForm = (e) => {
        ...
        if (e.target.value.trim() == "") {
            toastr.warning("Name cannot be null");
        }
    }
    ...
    //     if (e.target.value == "") {
    //         toastr.warning("DOB cannot be null");
    //     }
    // };
    ...
    //     dispatch(setEmployee(keyValue));
    //     if (e.target.value == "") {
    //         toastr.warning("Gender cannot be null");
    //     }
    // };
    ...
    //     console.log(e.target.value);
    //     if (e.target.value == "") {
    //         toastr.warning("Salary cannot be null");
    //     }
    // };
